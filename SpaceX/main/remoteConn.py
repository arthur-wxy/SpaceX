...
class SSH(object):
    ...
    def _key_connect(self):
        # 建立连接
        self.pkey = paramiko.RSAKey.from_private_key_file('/home/roo/.ssh/id_rsa.pub', )
...
if __name__ == "__main__":
    ssh = SSH(ip='10.151.66.60', username='AUXDC\crmadmin', password='auxp@ssw0rd')  # 创建一个ssh类对象
    ...
    remotefile, local_file = 'D:\dst2\\switch.html', '/Users/arthurw/Desktop/doc'
